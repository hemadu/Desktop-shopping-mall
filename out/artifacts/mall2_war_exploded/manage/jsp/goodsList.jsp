	   ...
	   <div class="xs">
           ...
           <div class="search-wrap" style="margin-left: 5px">
               <div class="search-content">
                   <form action="${pageContext.request.contextPath }/goods/list?change=0" method="post" name="queryForm">
                       ...
                       <div class="input-group">
                           <table class="search-tab">
                               ...
                               <button  style="padding: 3px 6px;height: 30px;margin-left: 2px;float: right;" type="button"  class="btn btn-default"><a style="text-decoration: none;"  href="${pageContext.request.contextPath}/manage/jsp/goodsAdd.jsp"><i class="fa fa-plus" aria-hidden="true"></i>增加</a></button>
...
<c:forEach var="goods" items="${list}" varStatus="status">
    ...
    <td style="line-height: 50px;" ><img src="${pageContext.request.contextPath}/images/${goods.pic}"  style="max-width:55px;"></td>
    <td style="width: 40%;">${goods.content}</td>
        <td>
            <a style="text-decoration: none;color: white;" class="updateNo" href="${pageContext.request.contextPath}/goods/update?id=${goods.id}" ><button  style="padding:2px 6px;" type="button" class="btn btn-sm btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
            <a style="text-decoration: none;color: white;" class="deleteNo" href="javascript:del(${goods.id})" ><button style="padding:2px 6px;text-decoration: none;color: white;" type="button" class="btn btn-sm btn-danger deleteSector"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
        </td>
    </tr>
</c:forEach>
