			...
			<div class="xs">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="horizontal-form">
						<form id="userForm" class="form-horizontal" name="userForm" method="post" action="${pageContext.request.contextPath }/pdetail/updateexe">
							<input type="hidden" class="form-control1" name="id"  value="${pdetail.id}">
							<input type="hidden" class="form-control1" name="gid"  value="${pdetail.gid}">

							<div class="form-group">
								<label  class="col-sm-2 control-label">数量</label>
								<div class="col-sm-8">
									<input type="text" class="form-control1" name="quantity"  value="${pdetail.quantity}">
								</div>
							</div>
