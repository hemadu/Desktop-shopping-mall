			...
			<div class="xs">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="horizontal-form">
						<form id="userForm" class="form-horizontal" name="userForm" method="post" action="${pageContext.request.contextPath }/goods/updateexe">
							<input type="hidden" class="form-control1" name="id"  value="${goods.id}">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control1" name="name"  value="${goods.name}">
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-2 control-label">单价</label>
								<div class="col-sm-8">
									<input type="text" class="form-control1" name="price" value="${goods.price}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control1" name="quantity"  value="${goods.quantity}">
								</div>
							</div>
...
<%--							</div>--%>
							...
							<div class="btns" style="margin-left: 125px;">
								...
								<img src="${pageContext.request.contextPath}/images/${goods.pic}" id="show" style="max-width:40px;margin-left: 30px;margin-bottom: 10px;"/>
							</div>
							<input  type="hidden" class="common-text required" id="img"  name="pic" value="${goods.pic}">
