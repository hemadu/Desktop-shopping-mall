...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
    ...
    <!-- Bootstrap Core CSS -->
    <link href="${pageContext.request.contextPath }/manage/css/bootstrap.min.css" rel='stylesheet' type='text/css' />
    <!-- Custom CSS -->
    <link href="${pageContext.request.contextPath }/manage/css/style.css" rel='stylesheet' type='text/css' />
    <link href="${pageContext.request.contextPath }/manage/css/font-awesome.css" rel="stylesheet">
