...
pageEncoding="UTF-8"%>
<div  style="width:100%;text-align:center;position: fixed;padding:12px 0px;bottom: 0px;background-color: #263D48;">
            <p class="footer-gd"><h4><a style="color:#FFF;" href="${pageContext.request.contextPath }/manage/jsp/login.jsp">后台管理</a></h4></p>
</div>
<!--外层的div-->
<div class="modal fade" id="updatePassModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" class="form-horizontal"action="${pageContext.request.contextPath }/bupdatepwd" onsubmit="return change()">
